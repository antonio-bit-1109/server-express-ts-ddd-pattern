...
container.bind<UserServices>(TYPES.USER_CONTROLLER).to(UserServices).inSingletonScope();
...
container.bind<UserRepository>(TYPES.USER_CONTROLLER).to(UserRepository).inSingletonScope();
